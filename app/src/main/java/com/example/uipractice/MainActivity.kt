    ...
    * */
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.navView.setNavigationItemSelectedListener {
            when(it.itemId)
            {
                R.id.miItem1 -> Toast.makeText(applicationContext,"item1 Clicked",Toast.LENGTH_SHORT).show()
                R.id.miItem2 -> Toast.makeText(applicationContext,"item2 Clicked",Toast.LENGTH_SHORT).show()
                R.id.miItem3 -> Toast.makeText(applicationContext,"item3 Clicked",Toast.LENGTH_SHORT).show()
            }
